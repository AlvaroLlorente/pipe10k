...
!------------------------------------------------------------------------
   subroutine mpi_precompute()
      ...
      call MPI_GROUP_INCL(MPI_COMM_WORLD, 15, subset_group, new_comm, mpi_er)
      call MPI_COMM_CREATE(MPI_COMM_WORLD, new_comm, subset_rank, mpi_er)
